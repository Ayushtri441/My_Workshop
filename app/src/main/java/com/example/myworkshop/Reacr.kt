...
import com.example.myworkshop.databinding.ActivityReacrBinding
import com.example.myworkshop.MainActivity.Companion.globalVar
class Reacr : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_reacr)
        ...
        btn.setOnClickListener {
            ...
            if (globalVar.equals("")) {
                ...
                val i = Intent(this@Reacr, Start::class.java)
                startActivity(i)
                finish()
            } else {
